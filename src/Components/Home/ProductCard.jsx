...
const ProductCard = ({
    ...
    return (
        ...
        >
            <div
                className="lg:w-[355px] 2xl:w-[465px] 2xl:mx-[5px] lg:h-[518px] 2xl:h-[599px] mb-10 lg:mb-0 overflow-hidden rounded-[10px]"
                style={{
            ...
            >
                <div
                    style={{
                        padding: '15px', // Padding moved to inner wrapper
                        display: 'flex',
